...
namespace ReBloxLauncher
{
    public partial class Form1 : Form
    {
        ...
        List<string> sha1assets = new List<string>(); // used to verify assets
        ...
        private void SetupGameFiles(bool studio = false, string client = null)
        {
            if (client != null)
            {
                        ...
                        if (Directory.Exists(datafolder + @"\clients\" + client + @"\Studio\ClientSettings"))
                        {
                            ...
                            if (File.Exists(datafolder + @"\clients\" + client + @"\Studio\ClientSettings\ClientAppSettings.json"))
                            {
                                if (File.ReadAllText(datafolder + @"\clients\" + client + @"\Studio\ClientSettings\ClientAppSettings.json").Contains("{id}"))
                                {
                                    ...
                                    File.WriteAllText(datafolder + @"\clients\" + client + @"\Studio\ClientSettings\ClientAppSettings.json", File.ReadAllText(datafolder + @"\clients\" + client + @"\Studio\ClientSettings\ClientAppSettings.json.bak").Replace("{id}", Properties.Settings.Default.UserId.ToString()));
                                }
                                ...
                                File.WriteAllText(datafolder + @"\tools\RobloxAssetFixer\ClientAppSettings.json", File.ReadAllText(datafolder + @"\clients\" + client + @"\Studio\ClientSettings\ClientAppSettings.json").Replace("{id}", Properties.Settings.Default.UserId.ToString()));
                            }
                        }
                    }
                    else
                        ...
                        if (Directory.Exists(datafolder + @"\clients\" + client + @"\Player\ClientSettings"))
                        {
                            ...
                            if (File.Exists(datafolder + @"\clients\" + client + @"\Player\ClientSettings\ClientAppSettings.json"))
                            {
                                if (File.ReadAllText(datafolder + @"\clients\" + client + @"\Player\ClientSettings\ClientAppSettings.json").Contains("{id}"))
                                {
                                    ...
                                    File.WriteAllText(datafolder + @"\clients\" + client + @"\Player\ClientSettings\ClientAppSettings.json", File.ReadAllText(datafolder + @"\clients\" + client + @"\Studio\ClientSettings\ClientAppSettings.json.bak").Replace("{id}", Properties.Settings.Default.UserId.ToString()));
                                }
                                if (File.Exists(datafolder + @"\tools\RobloxAssetFixer\ClientAppSettings.json")) File.Delete(datafolder + @"\tools\RobloxAssetFixer\ClientAppSettings.json");
                                File.WriteAllText(datafolder + @"\tools\RobloxAssetFixer\ClientAppSettings.json", File.ReadAllText(datafolder + @"\clients\" + client + @"\Player\ClientSettings\ClientAppSettings.json").Replace("{id}", Properties.Settings.Default.UserId.ToString()));
                            }
                        }
                ...
                {
                    throw new AccessViolationException("Attempted to access an non-existant client.");
                }
            }
            else
            {
...
#nullable disable
                                        ...
                                        if (textBox1.Text != "localhost" && textBox1.Text != "127.0.0.1")
                                        {
                                            this.Invoke(new Action(() =>
                                            {
                                                if (Properties.Settings.Default.useAuth && internetConnected)
                                                {
                                                    ...
                                                    {
                                                        if (Properties.Settings.Default.AccountOver13) ps1.Arguments = datafolder + @"\tools\RobloxAssetFixer\index.js --syncROBLOSECURITYfromLauncher -username=" + Properties.Settings.Default.username + " -userid=" + Properties.Settings.Default.UserId + " -r15 -bodycolor=[" + Properties.Settings.Default.HeadColor + "," + Properties.Settings.Default.LeftArmColor + "," + Properties.Settings.Default.LeftLegColor + "," + Properties.Settings.Default.RightArmColor + "," + Properties.Settings.Default.RightLegColor + "," + Properties.Settings.Default.TorsoColor + "] -clothes=[" + Properties.Settings.Default.ClothesArray.Replace("|", ",") + "] -ip=\"" + textBox1.Text + "\" -joining " + (Properties.Settings.Default.EnableDataStore ? "" : "-disableDataStore ") + (Properties.Settings.Default.EnableBadges ? "" : "-disableBadges ") + (Properties.Settings.Default.EnableFollowing ? "" : "-disableFollowing ") + (Properties.Settings.Default.assetFromServer ? "-assetFromServer " : "") + (useOldSignature ? "-disableNewSignature " : "") + (useOldAssetFormat ? "-disableNewSignatureAsset " : "") + (Properties.Settings.Default.EnableFriendships ? "" : "-disableFriendships ") + (Properties.Settings.Default.EnableOwnedAssets ? "" : "-disableOwnedAssets ") + "-robux=" + Properties.Settings.Default.Robux + " --allowGetCurrentUser" + (Properties.Settings.Default.UploadFilesAllowed ? " --allowUploadingFiles" : "") + (Properties.Settings.Default.EnableDataPersistence ? "" : " -disableDataPersistence") + (Properties.Settings.Default.RBDFPath != "default.rbdf" && Properties.Settings.Default.RBDFPath != "" ? " -rbdf=\"" + Properties.Settings.Default.RBDFPath + "\"" : "");
                                                        else ps1.Arguments = datafolder + @"\tools\RobloxAssetFixer\index.js --syncROBLOSECURITYfromLauncher -username=" + Properties.Settings.Default.username + " -userid=" + Properties.Settings.Default.UserId + " -accountUnder13 -r15 -bodycolor=[" + Properties.Settings.Default.HeadColor + "," + Properties.Settings.Default.LeftArmColor + "," + Properties.Settings.Default.LeftLegColor + "," + Properties.Settings.Default.RightArmColor + "," + Properties.Settings.Default.RightLegColor + "," + Properties.Settings.Default.TorsoColor + "] -clothes=[" + Properties.Settings.Default.ClothesArray.Replace("|", ",") + "] -ip=\"" + textBox1.Text + "\" -joining " + (Properties.Settings.Default.EnableDataStore ? "" : "-disableDataStore ") + (Properties.Settings.Default.EnableBadges ? "" : "-disableBadges ") + (Properties.Settings.Default.EnableFollowing ? "" : "-disableFollowing ") + (Properties.Settings.Default.assetFromServer ? "-assetFromServer " : "") + (useOldSignature ? "-disableNewSignature " : "") + (useOldAssetFormat ? "-disableNewSignatureAsset " : "") + (Properties.Settings.Default.EnableFriendships ? "" : "-disableFriendships ") + (Properties.Settings.Default.EnableOwnedAssets ? "" : "-disableOwnedAssets ") + "-robux=" + Properties.Settings.Default.Robux + " --allowGetCurrentUser" + (Properties.Settings.Default.UploadFilesAllowed ? " --allowUploadingFiles" : "") + (Properties.Settings.Default.EnableDataPersistence ? "" : " -disableDataPersistence") + (Properties.Settings.Default.RBDFPath != "default.rbdf" && Properties.Settings.Default.RBDFPath != "" ? " -rbdf=\"" + Properties.Settings.Default.RBDFPath + "\"" : "");
                                                    }
                                                    else if (Properties.Settings.Default.AccountOver13) ps1.Arguments = datafolder + @"\tools\RobloxAssetFixer\index.js --syncROBLOSECURITYfromLauncher -username=" + Properties.Settings.Default.username + " -userid=" + Properties.Settings.Default.UserId + " -bodycolor=[" + Properties.Settings.Default.HeadColor + "," + Properties.Settings.Default.LeftArmColor + "," + Properties.Settings.Default.LeftLegColor + "," + Properties.Settings.Default.RightArmColor + "," + Properties.Settings.Default.RightLegColor + "," + Properties.Settings.Default.TorsoColor + "] -clothes=[" + Properties.Settings.Default.ClothesArray.Replace("|", ",") + "] -ip=\"" + textBox1.Text + "\" -joining " + (Properties.Settings.Default.EnableDataStore ? "" : "-disableDataStore ") + (Properties.Settings.Default.EnableBadges ? "" : "-disableBadges ") + (Properties.Settings.Default.EnableFollowing ? "" : "-disableFollowing ") + (Properties.Settings.Default.assetFromServer ? "-assetFromServer " : "") + (useOldSignature ? "-disableNewSignature " : "") + (useOldAssetFormat ? "-disableNewSignatureAsset " : "") + (Properties.Settings.Default.EnableFriendships ? "" : "-disableFriendships ") + (Properties.Settings.Default.EnableOwnedAssets ? "" : "-disableOwnedAssets ") + "-robux=" + Properties.Settings.Default.Robux + " --allowGetCurrentUser" + (Properties.Settings.Default.UploadFilesAllowed ? " --allowUploadingFiles" : "") + (Properties.Settings.Default.EnableDataPersistence ? "" : " -disableDataPersistence") + (Properties.Settings.Default.RBDFPath != "default.rbdf" && Properties.Settings.Default.RBDFPath != "" ? " -rbdf=\"" + Properties.Settings.Default.RBDFPath + "\"" : "");
                                                    else ps1.Arguments = datafolder + @"\tools\RobloxAssetFixer\index.js --syncROBLOSECURITYfromLauncher -username=" + Properties.Settings.Default.username + " -userid=" + Properties.Settings.Default.UserId + " -accountUnder13 -bodycolor=[" + Properties.Settings.Default.HeadColor + "," + Properties.Settings.Default.LeftArmColor + "," + Properties.Settings.Default.LeftLegColor + "," + Properties.Settings.Default.RightArmColor + "," + Properties.Settings.Default.RightLegColor + "," + Properties.Settings.Default.TorsoColor + "] -clothes=[" + Properties.Settings.Default.ClothesArray.Replace("|", ",") + "] -ip=\"" + textBox1.Text + "\" -joining " + (Properties.Settings.Default.EnableDataStore ? "" : "-disableDataStore ") + (Properties.Settings.Default.EnableBadges ? "" : "-disableBadges ") + (Properties.Settings.Default.EnableFollowing ? "" : "-disableFollowing ") + (Properties.Settings.Default.assetFromServer ? "-assetFromServer " : "") + (useOldSignature ? "-disableNewSignature " : "") + (useOldAssetFormat ? "-disableNewSignatureAsset " : "") + (Properties.Settings.Default.EnableFriendships ? "" : "-disableFriendships ") + (Properties.Settings.Default.EnableOwnedAssets ? "" : "-disableOwnedAssets ") + "-robux=" + Properties.Settings.Default.Robux + " --allowGetCurrentUser" + (Properties.Settings.Default.UploadFilesAllowed ? " --allowUploadingFiles" : "") + (Properties.Settings.Default.EnableDataPersistence ? "" : " -disableDataPersistence") + (Properties.Settings.Default.RBDFPath != "default.rbdf" && Properties.Settings.Default.RBDFPath != "" ? " -rbdf=\"" + Properties.Settings.Default.RBDFPath + "\"" : "");
                                                }
                                                else
                                                {
                                                    if (Properties.Settings.Default.avatarR15)
        ...
        private void checkBox13_CheckedChanged(object sender, EventArgs e)
        {
            if (starting == false)
            {
                ...
                {
                    if (MessageBox.Show("Are you sure you wanna enable this? Enabling the ability to upload files from your clients will pose a security risk to your computer!", "ReBlox", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                    {
