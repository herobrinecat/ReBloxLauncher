        ...
        private void Initialize()
        {
            try
            {
                if (launchershortcut == false)
                {
                    ...
                    {
                        if (MessageBox.Show("It looks like you're running on Windows 7, you must download the patch for ReBlox in order for ReBlox to be usable on Windows 7, do you wanna apply the patch? (This node/its dependencies patch may contain security vulnerabilities, please be cautious when running the server, especially with public servers.)", "ReBlox", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                        {
                        ...
                        if (File.ReadAllText(@"C:\Windows\System32\drivers\etc\hosts").Contains("\r\n127.0.0.1 reblox.zip\r\n127.0.0.1 www.reblox.zip\r\n127.0.0.1 api.reblox.zip\r\n127.0.0.1 assetgame.reblox.zip\r\n127.0.0.1 auth.reblox.zip\r\n127.0.0.1 assetdelivery.reblox.zip\r\n127.0.0.1 develop.reblox.zip\r\n127.0.0.1 clientsettings.api.reblox.zip\r\n127.0.0.1 gamepersistence.reblox.zip\r\n127.0.0.1 avatar.reblox.zip\r\n127.0.0.1 thumbnails.reblox.zip\r\n127.0.0.1 groups.reblox.zip\r\n127.0.0.1 clientsettingscdn.reblox.zip\r\n127.0.0.1 catalog.reblox.zip\r\n127.0.0.1 apis.reblox.zip\r\n127.0.0.1 games.reblox.zip\r\n127.0.0.1 friends.reblox.zip\r\n127.0.0.1 economy.reblox.zip\r\n127.0.0.1 badges.reblox.zip\r\n127.0.0.1 users.reblox.zip\r\n127.0.0.1 locale.reblox.zip\r\n127.0.0.1 versioncompatibility.api.reblox.zip\r\n127.0.0.1 data.reblox.zip\r\n127.0.0.1 abtesting.reblox.zip\r\n127.0.0.1 inventory.reblox.zip\r\n127.0.0.1 premiumfeatures.reblox.zip\r\n127.0.0.1 chat.reblox.zip\r\n127.0.0.1 gameinternationalization.reblox.zip") == false && Properties.Settings.Default.UsePatchInStudio == true && WineDetector.IsRunningOnWine() == false)
                        {
                            if (MessageBox.Show("Wanna edit the hosts file to make sure that decals loads? This is recommended for best experience!\n\nIf you wanna load assets, provide your .ROBLOSECURITY in the settings section and enable Use auth for loading assets. (This will not conflict with your latest Roblox Studio)", "ReBlox", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                            {
                                if (IsAdministrator())
                                {
                                    ...
                                    {
                                        ps1.Arguments = "index.js -username=" + Properties.Settings.Default.username + " -userid=" + Properties.Settings.Default.UserId + (Properties.Settings.Default.EnableBadges ? "" : " -disableBadges") + (Properties.Settings.Default.EnableDataStore ? "" : " -disableDataStore") + (Properties.Settings.Default.EnableFollowing ? "" : " -disableFollowing") + (Properties.Settings.Default.EnableFriendships ? "" : " -disableFriendships") + (Properties.Settings.Default.EnableOwnedAssets ? "" : " -disableOwnedAssets") + (Properties.Settings.Default.AccountOver13 ? "" : " -accountUnder13") + " -robux=" + Properties.Settings.Default.Robux + " --allowGetCurrentUser" + (useOldAssetFormat ? " -disableNewSignatureAsset" : "") + (useOldSignature ? " -disableNewSignature" : "");
                                    }
                            ...
                            for (int i = 0; i < config.Length; i++)
                            {
                                ...
                                else if (config[i].Trim() == "2018OverMessage=true")
                                {
                                    if (Properties.Settings.Default.UsePatchInStudio == false)
                                    {
                                        if (caInstalled)
                                        {
                                            MessageBox.Show("Note that RobloxAssetFixer is strongly recommended to be able to use this client property and login. You should turn on \"Use RobloxAssetFixer when opening in Studio mode\", located in Settings [If you're launching in Studio]", "ReBlox", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                                        }
                                        else
                                        {
                                    ...
                                    else
                                    {
                                        if (caInstalled == false)
                                        {
                                            ...
                                            button2.Enabled = false;
                                            button3.Enabled = false;
                                            MessageBox.Show("The CA certificate is required to be able to use 2018+ clients. You can install the CA certificate by going to Settings > Install CA.", "ReBlox", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                        }
                                        else
                                        {
            ...
            if (listBox1.SelectedIndex != -1)
            {
                ...
                Thread thread = new Thread(async () =>
                {
                    try
                    {
                        ...
                        {
                            if (File.ReadAllText(@"C:\Windows\System32\drivers\etc\hosts").Contains("\r\n127.0.0.1 reblox.zip\r\n127.0.0.1 www.reblox.zip\r\n127.0.0.1 api.reblox.zip\r\n127.0.0.1 assetgame.reblox.zip\r\n127.0.0.1 auth.reblox.zip\r\n127.0.0.1 assetdelivery.reblox.zip\r\n127.0.0.1 develop.reblox.zip\r\n127.0.0.1 clientsettings.api.reblox.zip\r\n127.0.0.1 gamepersistence.reblox.zip\r\n127.0.0.1 avatar.reblox.zip\r\n127.0.0.1 thumbnails.reblox.zip\r\n127.0.0.1 groups.reblox.zip\r\n127.0.0.1 clientsettingscdn.reblox.zip\r\n127.0.0.1 catalog.reblox.zip\r\n127.0.0.1 apis.reblox.zip\r\n127.0.0.1 games.reblox.zip\r\n127.0.0.1 friends.reblox.zip\r\n127.0.0.1 economy.reblox.zip\r\n127.0.0.1 badges.reblox.zip\r\n127.0.0.1 users.reblox.zip\r\n127.0.0.1 locale.reblox.zip\r\n127.0.0.1 versioncompatibility.api.reblox.zip\r\n127.0.0.1 data.reblox.zip\r\n127.0.0.1 abtesting.reblox.zip\r\n127.0.0.1 inventory.reblox.zip\r\n127.0.0.1 premiumfeatures.reblox.zip\r\n127.0.0.1 chat.reblox.zip\r\n127.0.0.1 gameinternationalization.reblox.zip") == false && WineDetector.IsRunningOnWine() == false)
                            {
                                if (MessageBox.Show("Wanna edit the hosts file to make sure that decals loads? This is recommended for best experience!\n\nIf you wanna load assets, provide your .ROBLOSECURITY in the settings section and enable Use auth for loading assets. (This will not conflict with your latest Roblox Studio)", "ReBlox", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                                {
                                    if (IsAdministrator())
                                        ...
                                        if (textBox1.Text != "localhost" && textBox1.Text != "127.0.0.1")
                                        {
                                            this.Invoke(new Action(() =>
                                            {
                                                if (Properties.Settings.Default.useAuth && internetConnected)
                                                {
                                                    ...
                                                    {
                                                        if (Properties.Settings.Default.AccountOver13) ps1.Arguments = datafolder + @"\tools\RobloxAssetFixer\index.js -ROBLOSECURITY=" + Encoding.UTF8.GetString(Convert.FromBase64String(Properties.Settings.Default.ROBLOSECURITY)).Trim(new char[] { '\0' }) + " -useAuth -username=" + Properties.Settings.Default.username + " -userid=" + Properties.Settings.Default.UserId + " -r15 -bodycolor=[" + Properties.Settings.Default.HeadColor + "," + Properties.Settings.Default.LeftArmColor + "," + Properties.Settings.Default.LeftLegColor + "," + Properties.Settings.Default.RightArmColor + "," + Properties.Settings.Default.RightLegColor + "," + Properties.Settings.Default.TorsoColor + "] -clothes=[" + Properties.Settings.Default.ClothesArray.Replace("|", ",") + "] -ip=\"" + textBox1.Text + "\" -joining " + (Properties.Settings.Default.EnableDataStore ? "" : "-disableDataStore ") + (Properties.Settings.Default.EnableBadges ? "" : "-disableBadges ") + (Properties.Settings.Default.EnableFollowing ? "" : "-disableFollowing ") + (Properties.Settings.Default.assetFromServer ? "-assetFromServer " : "") + (useOldSignature ? "-disableNewSignature " : "") + (useOldAssetFormat ? "-disableNewSignatureAsset " : "") + (Properties.Settings.Default.EnableFriendships ? "" : "-disableFriendships ") + (Properties.Settings.Default.EnableOwnedAssets ? "" : "-disableOwnedAssets ") + "-robux=" + Properties.Settings.Default.Robux + " --allowGetCurrentUser";
                                                        else ps1.Arguments = datafolder + @"\tools\RobloxAssetFixer\index.js -ROBLOSECURITY=" + Encoding.UTF8.GetString(Convert.FromBase64String(Properties.Settings.Default.ROBLOSECURITY)).Trim(new char[] { '\0' }) + " -useAuth -username=" + Properties.Settings.Default.username + " -userid=" + Properties.Settings.Default.UserId + " -accountUnder13 -r15 -bodycolor=[" + Properties.Settings.Default.HeadColor + "," + Properties.Settings.Default.LeftArmColor + "," + Properties.Settings.Default.LeftLegColor + "," + Properties.Settings.Default.RightArmColor + "," + Properties.Settings.Default.RightLegColor + "," + Properties.Settings.Default.TorsoColor + "] -clothes=[" + Properties.Settings.Default.ClothesArray.Replace("|", ",") + "] -ip=\"" + textBox1.Text + "\" -joining " + (Properties.Settings.Default.EnableDataStore ? "" : "-disableDataStore ") + (Properties.Settings.Default.EnableBadges ? "" : "-disableBadges ") + (Properties.Settings.Default.EnableFollowing ? "" : "-disableFollowing ") + (Properties.Settings.Default.assetFromServer ? "-assetFromServer " : "") + (useOldSignature ? "-disableNewSignature " : "") + (useOldAssetFormat ? "-disableNewSignatureAsset " : "") + (Properties.Settings.Default.EnableFriendships ? "" : "-disableFriendships ") + (Properties.Settings.Default.EnableOwnedAssets ? "" : "-disableOwnedAssets ") + "-robux=" + Properties.Settings.Default.Robux + " --allowGetCurrentUser";
                                                    }
                                                    else if (Properties.Settings.Default.AccountOver13) ps1.Arguments = datafolder + @"\tools\RobloxAssetFixer\index.js -ROBLOSECURITY=" + Encoding.UTF8.GetString(Convert.FromBase64String(Properties.Settings.Default.ROBLOSECURITY)).Trim(new char[] { '\0' }) + " -useAuth -username=" + Properties.Settings.Default.username + " -userid=" + Properties.Settings.Default.UserId + " -bodycolor=[" + Properties.Settings.Default.HeadColor + "," + Properties.Settings.Default.LeftArmColor + "," + Properties.Settings.Default.LeftLegColor + "," + Properties.Settings.Default.RightArmColor + "," + Properties.Settings.Default.RightLegColor + "," + Properties.Settings.Default.TorsoColor + "] -clothes=[" + Properties.Settings.Default.ClothesArray.Replace("|", ",") + "] -ip=\"" + textBox1.Text + "\" -joining " + (Properties.Settings.Default.EnableDataStore ? "" : "-disableDataStore ") + (Properties.Settings.Default.EnableBadges ? "" : "-disableBadges ") + (Properties.Settings.Default.EnableFollowing ? "" : "-disableFollowing ") + (Properties.Settings.Default.assetFromServer ? "-assetFromServer " : "") + (useOldSignature ? "-disableNewSignature " : "") + (useOldAssetFormat ? "-disableNewSignatureAsset " : "") + (Properties.Settings.Default.EnableFriendships ? "" : "-disableFriendships ") + (Properties.Settings.Default.EnableOwnedAssets ? "" : "-disableOwnedAssets ") + "-robux=" + Properties.Settings.Default.Robux + " --allowGetCurrentUser";
                                                    else ps1.Arguments = datafolder + @"\tools\RobloxAssetFixer\index.js -ROBLOSECURITY=" + Encoding.UTF8.GetString(Convert.FromBase64String(Properties.Settings.Default.ROBLOSECURITY)).Trim(new char[] { '\0' }) + " -useAuth -username=" + Properties.Settings.Default.username + " -userid=" + Properties.Settings.Default.UserId + " -accountUnder13 -bodycolor=[" + Properties.Settings.Default.HeadColor + "," + Properties.Settings.Default.LeftArmColor + "," + Properties.Settings.Default.LeftLegColor + "," + Properties.Settings.Default.RightArmColor + "," + Properties.Settings.Default.RightLegColor + "," + Properties.Settings.Default.TorsoColor + "] -clothes=[" + Properties.Settings.Default.ClothesArray.Replace("|", ",") + "] -ip=\"" + textBox1.Text + "\" -joining " + (Properties.Settings.Default.EnableDataStore ? "" : "-disableDataStore ") + (Properties.Settings.Default.EnableBadges ? "" : "-disableBadges ") + (Properties.Settings.Default.EnableFollowing ? "" : "-disableFollowing ") + (Properties.Settings.Default.assetFromServer ? "-assetFromServer " : "") + (useOldSignature ? "-disableNewSignature " : "") + (useOldAssetFormat ? "-disableNewSignatureAsset " : "") + (Properties.Settings.Default.EnableFriendships ? "" : "-disableFriendships ") + (Properties.Settings.Default.EnableOwnedAssets ? "" : "-disableOwnedAssets ") + "-robux=" + Properties.Settings.Default.Robux + " --allowGetCurrentUser";
                                                }
                                                else
                                                {
                                                    if (Properties.Settings.Default.avatarR15)
                                ...
                                {
                                    launchingClient = false;
                                    MessageBox.Show("Joining on Player clients requires changing your hosts file!", "ReBlox", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                }
                            }
                            else
                            {
        ...
        private void textBox3_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                if (textBox3.Text.StartsWith("_|WARNING:-DO-NOT-SHARE-THIS.--Sharing-this-will-allow-someone-to-log-in-as-you-and-to-steal-your-ROBUX-and-items.|"))
                {
                    ...
                    Properties.Settings.Default.Save();
                    MessageBox.Show("Your ROBLOSECURITY is hidden by default, however you can show your ROBLOSECURITY by clicking on the \"Show\" button. Please be careful with your ROBLOSECURITY!", "ReBlox", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                else
                {
